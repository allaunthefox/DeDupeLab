...
def write_folder_meta(folder_path: Path, file_records: list, root_path: Path, pretty: bool = False, silent: bool = True):
    """
    Write deduplab_meta_v4 meta.json for a folder.
    
    Args:
        folder_path: Directory to write meta.json in
        file_records: List of dicts with name, size, mtime, sha256, mime, context_tag
        root_path: Root scan directory for relative paths
